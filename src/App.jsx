      ...
      {status === null && messages.length === 0 && (
        <div className="h-full overflow-auto scrollbar-thin flex justify-center items-center flex-col relative">
          <div className="flex flex-col items-center mb-1 max-w-[340px] text-center">
            ...
            />
            <h1 className="text-4xl font-bold mb-1">LFM-2.5 JP Web 🤖</h1>
          ...
          <div className="flex flex-col items-center px-4">
            <p className="max-w-[514px] mb-4">
              ...
              <a
                href="https://huggingface.co/LiquidAI/LFM2.5-1.2B-JP-ONNX"
                target="_blank"
                rel="noreferrer"
              ...
              , a 1.2 billion parameter japanese LLM that is optimized for inference on
              ...
              <a
                href="https://github.com/sitammeur/lfm2.5-jp-web"
                target="_blank"
                rel="noreferrer"
                className="underline"
              >
